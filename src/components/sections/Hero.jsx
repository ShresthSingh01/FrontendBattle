...
export default function Hero() {
  ...
  return (
    <section id="hero" aria-label="Hero" className="min-h-screen relative flex items-end pb-24 overflow-hidden pt-32">
      <div className="w-full max-w-7xl mx-auto px-8 w-full grid grid-cols-1 md:grid-cols-[25%_1fr_25%]">
        <div className="col-span-1 md:col-start-2 md:col-end-3 relative z-10 flex flex-col justify-end">
          <h1 
            style={{ opacity: 0 }}
        ...
        <div 
          className="col-span-1 md:col-start-3 md:col-end-4 flex md:flex-col gap-6 justify-center md:items-end md:pl-8 mt-12 md:mt-0 flex-wrap" 
