...
export default function WhyUs() {
  return (
    <section data-reveal id="why-us" className="grid md:grid-cols-2 min-h-[800px]">
      ...
      {/* Left Dark Side */}
      <div className="bg-oceanic-noir relative overflow-hidden flex items-center justify-center p-12 lg:p-24">
      ...
      {/* Right Light Side */}
      <div className="bg-arctic-powder text-oceanic-noir p-12 lg:p-24 flex flex-col justify-center">
