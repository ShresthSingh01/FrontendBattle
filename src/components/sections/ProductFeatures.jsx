...
export default function ProductFeatures() {
  return (
    <section id="product-features" className="bg-[#0a0a0a] pt-32">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-4 gap-8 mb-32">
          <div className="col-start-2 col-span-2 border border-[rgba(255,255,255,0.1)] rounded-xl bg-[#0f0f0f] p-8 min-h-[400px] flex items-center justify-center relative overflow-hidden">
            ...
            <div className="flex items-center gap-8 relative z-10 opacity-70">
              ...
              {/* Sub-group box */}
              <div className="border border-[rgba(255,255,255,0.1)] p-4 rounded-lg flex gap-8 items-center bg-[#111111]">
        ...
        <div className="grid grid-cols-4 border-t border-[rgba(255,255,255,0.08)]">
          {[
            {
