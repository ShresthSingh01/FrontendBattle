        ...
        <div className="col-span-1 md:col-start-2 md:col-span-3">
          ...
          <div className="border-t border-black/10">
            {caseStudies.map((study, idx) => (
              <div 
                key={idx} 
                className="group grid grid-cols-1 md:grid-cols-[180px_120px_1fr_60px] gap-4 md:gap-0 items-start md:items-center py-10 border-b border-black/10 cursor-pointer transition-colors duration-150 ease-out hover:bg-oceanic-noir/[0.03] overflow-hidden px-4 md:px-0"
              >
