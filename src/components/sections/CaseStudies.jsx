...
export default function CaseStudies() {
  return (
    <section id="case-studies" className="bg-[#f0f0ee] pt-24 pb-32">
        ...
        <div className="col-start-2 col-span-3">
          ...
          <div className="border-t border-black/10">
            {caseStudies.map((study, idx) => (
              <div 
                key={idx} 
                className="group grid grid-cols-[180px_120px_1fr_60px] items-center py-10 border-b border-black/10 cursor-pointer transition-colors duration-150 ease-out hover:bg-black/[0.03] overflow-hidden"
              >
                <div className="font-sans font-bold text-xl text-black pl-4">
                  {study.logo}
                </div>
                ...
                <div>
                  <h3 className="font-sans text-xl font-medium text-[#111111] mb-2">
                    {study.title}
                  </h3>
                ...
                <div className="font-mono text-xl text-black transition-transform duration-150 ease-out group-hover:translate-x-1.5">
                  &gt;&gt;
                </div>
              </div>
            ))}
