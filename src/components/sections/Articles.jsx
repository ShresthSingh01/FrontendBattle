...
export default function Articles() {
  return (
    <section id="articles" className="bg-[#f0f0ee] pt-32 pb-32">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16">
          ...
          <p className="font-sans text-lg text-black/70 max-w-2xl">
        ...
        <div className="articles-grid">
          ...
          <article className="article-featured cursor-pointer bg-black">
            <img 
          ...
          <div className="flex flex-col">
            <article className="article-small p-6 cursor-pointer hover:bg-black/5 transition-colors group">
              <div className="w-[140px] h-[100px] overflow-hidden bg-black mr-6">
                <img 
              ...
              <div className="flex flex-col justify-center">
                <h3 className="font-sans font-bold text-lg text-black mb-2 line-clamp-2">
                  Optimizing Context Windows for Large Language Models
                </h3>
                <div className="font-mono text-xs text-black/50 uppercase tracking-wider">
                  Oct 02, 2026
                </div>
              </div>
            </article>

            <article className="article-small p-6 cursor-pointer hover:bg-black/5 transition-colors border-none group">
              <div className="w-[140px] h-[100px] overflow-hidden bg-black mr-6">
                <img 
            ...
            <div className="flex-1 border-t border-black/10 p-6 flex flex-col justify-center bg-transparent">
              <p className="font-sans text-black/70 mb-4">Access all our articles in one place.</p>
              <div>
                <button className="bg-transparent border border-black/20 text-black px-6 py-2 text-sm font-mono tracking-wider hover:border-black transition-colors uppercase">
                  View Articles
                </button>
              </div>
            </div>
