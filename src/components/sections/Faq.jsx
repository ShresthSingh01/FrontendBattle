...
export default function Faq() {
  ...
  return (
    <section data-reveal id="faq" className="bg-arctic-powder text-oceanic-noir pt-32 pb-32 border-t border-black/5">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-12 gap-16">
        
        {/* Left: Heading & Contact */}
        <div className="md:col-span-5">
          <h2 className="text-4xl md:text-5xl font-sans font-bold text-oceanic-noir mb-6 tracking-tight relative">
            <span className="relative z-10">Common inquiries</span>
            {/* Faint background logo/mark hint */}
            <div className="absolute -top-8 -left-8 text-oceanic-noir/5 text-[120px] leading-none select-none z-0">
              NX
            </div>
          </h2>
          <p className="font-sans text-lg text-oceanic-noir/70 mb-10 relative z-10">
            Everything you need to know about integrating NexaFlow into your architecture. Can't find the answer you're looking for?
          </p>
          <button className="bg-oceanic-noir text-white px-8 py-3 text-sm font-mono tracking-wider hover:bg-forsythia hover:text-oceanic-noir transition-colors uppercase relative z-10">
            Contact Us
          </button>
        </div>
              ...
              return (
                <div key={i} className="faq-item">
                  ...
                  <div className={`faq-answer ${isOpen ? 'open' : ''}`}>
                    <div className="pb-6 pl-12 pr-12 text-oceanic-noir/60">
                      {faq.a}
                    </div>
                  </div>
                </div>
