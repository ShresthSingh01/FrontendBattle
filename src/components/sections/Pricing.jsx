...
export default function Pricing() {
  ...
  return (
    <section id="pricing" aria-label="Pricing plans" className="bg-[#f0f0ee] pt-24 pb-32">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-4 gap-8">
        
        <div className="col-start-2 col-span-3">
          
          <div className="mb-16">
            <div className="font-mono text-xs uppercase tracking-wider text-black flex items-center gap-4 mb-8">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                <path d="M0,24 L24,0 M-12,24 L12,0 M12,48 L36,24" stroke="black"/>
              </svg>
              PRICING MATRIX
            </div>
            <h2 className="text-4xl font-sans font-bold text-black mb-6">
              Scale without surprises
            </h2>
            <p className="font-sans text-lg text-black/70 max-w-2xl mb-12">
            ...
            <div className="pricing-controls flex items-center gap-6">
              ...
              <select
                ...
                defaultValue="USD"
                className="currency-select bg-white border border-black/10 rounded-md px-4 py-2 font-mono text-sm text-black outline-none focus:border-forsythia transition-colors appearance-none pr-10 cursor-pointer relative"
              >
          ...
          <div className="pricing-cards grid grid-cols-3 gap-6">
            {Object.entries(PRICING_MATRIX.tiers).map(([tierKey, tier]) => (
              ...
              >
                ...
                <button className={`pricing-cta w-full py-3 text-sm font-mono tracking-wider transition-colors border ${tier.badge ? 'bg-forsythia text-[#172B36] border-forsythia hover:bg-[#FF9932] hover:border-[#FF9932]' : 'bg-transparent text-black border-black/20 hover:border-black'}`}>
                  {tier.cta}
                </button>
              </article>
            ))}
